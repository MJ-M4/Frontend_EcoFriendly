  ...
  const handleAddShift = async () => {
    if (
      ...
      const foundEmployee = employees.find(
        (e) => e.identity === newShift.worker_id
      );
      if (!foundEmployee) {
        alert(
          "Invalid Worker ID. Check Employees for correct numeric identity."
        );
        return;
      }
      if (foundEmployee.worker_type !== newShift.worker_type) {
        alert(
          `Worker with ID ${foundEmployee.identity} is a ${foundEmployee.worker_type}, not a ${newShift.worker_type}.`
        );
        return;
      }
      ...
      <div className="content">
        ...
        <div className="form-container add-shift-form">
          <input
            ...
            onChange={(e) =>
              setNewShift({ ...newShift, worker_id: e.target.value })
            }
          ...
          <select
            ...
            onChange={(e) =>
              setNewShift({ ...newShift, worker_type: e.target.value })
            }
            className="form-input"
          >
          ...
          {updateWorkerId && (
            <>
              <input
                ...
                onChange={(e) =>
                  setUpdatedShift({ ...updatedShift, date: e.target.value })
                }
                className="form-input"
              />
              <input
              ...
              <input
                ...
                onChange={(e) =>
                  setUpdatedShift({ ...updatedShift, end_time: e.target.value })
                }
                className="form-input"
              />
              <input
                ...
                onChange={(e) =>
                  setUpdatedShift({ ...updatedShift, location: e.target.value })
                }
                className="form-input"
              />
        ...
        {isLoading ? (
          ...
          <p>No shifts found, you can add shifts for employees</p>)
           : (
